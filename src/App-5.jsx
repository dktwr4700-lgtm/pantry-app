...
// Meal bank for the personalized calculator plan — 7 distinct options
// per meal type, grouped by calorie tier (matches the calorie target
// computed from the user's own profile).
const MEAL_BANK = {
  low: {
...
export default function App() {
  ...
  const [tab, setTab] = useState(() => {
    // Support home-screen shortcuts that jump straight to a tab,
    // e.g. installing the app with start_url "/?view=shopping".
    try {
